...
namespace AssortedCallouts
{
    ...
    internal class Main : Plugin
    {
        ...
        public override void Initialize()
        {
            ...
            Game.LogTrivial("Assorted Callouts " + Assembly.GetExecutingAssembly().GetName().Version.ToString() + ", by Albo1125 updated by Aschtar for LSPDFR 0.4.9");
        ...
        internal static Version RAGENativeUIVersion = new Version("1.9.0.0");
